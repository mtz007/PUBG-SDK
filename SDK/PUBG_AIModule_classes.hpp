...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0480(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x0480(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0480(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0480(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0480(0x0001)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0480(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0481(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x0488(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0490(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0498(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x04A0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x04A8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x04B0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x04B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x04C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	unsigned char                                      bDrawLabels : 1;                                          // 0x083C(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x083C(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x083C(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x083C(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x083C(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x083D(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x0840(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2F];                                      // 0x0841(0x002F) MISSED OFFSET
