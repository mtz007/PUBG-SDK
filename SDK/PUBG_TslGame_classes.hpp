...
public:
	...
	unsigned char                                      UnknownData10[0x28];                                      // 0x0678(0x0028) MISSED OFFSET
	struct FTslReplaySummary                           ReplaySummaryForPlayback;                                 // 0x06A0(0x0080) (BlueprintVisible, BlueprintReadOnly)
	struct FScriptMulticastDelegate                    OnGetReplaySummaryDone;                                   // 0x0720(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	bool                                               bIsStartedFromReplayListMap;                              // 0x0730(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x0731(0x0007) MISSED OFFSET
	class ATslPlayerState*                             CachedDemoPlayerState;                                    // 0x0738(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData12[0x140];                                     // 0x0740(0x0140) MISSED OFFSET
	class UHighlightSession*                           HighlightSession;                                         // 0x0880(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData13[0xE8];                                      // 0x0888(0x00E8) MISSED OFFSET
